...
public class Notice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notice_name = findViewById(R.id.notice_name);
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult activityResult) {
                    ...
                    if (result == RESULT_OK) {
                        ...
                        final String messagePushID = notice_name.getText().toString();
                        ...
                        filepath.putFile(pdfuri).continueWithTask(new Continuation() {
                            ...
                            if ((task.isSuccessful())) {
                                ...
                                progressBar.setVisibility(View.GONE);
                                Toast.makeText(Notice.this, "Upload Failed", Toast.LENGTH_SHORT).show();
                            }
                        });
                    } else {
